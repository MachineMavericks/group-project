...
def resilience():
    plotly_resilience(pickle_path=pickle_filepath, output_path='static/output/plotly.html', strategy=request.args.get('type'),
                      component=request.args.get('component'), metric=request.args.get('metric'), day=request.args.get('day'), fraction=request.args.get('fraction'))
